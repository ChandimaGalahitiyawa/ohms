...
<div class="w-full p-6 mx-auto">
    ...
    <form class="relative" enctype="multipart/form-data" onsubmit="handleFormSubmission()" id="main-form"  action="{{ route('storeDoctorNotes', $booking->id) }}" method="post">
        @csrf
        
        <div class="flex flex-wrap -mx-3">
            <div class="w-full max-w-full px-3 shrink-0 lg:flex-0 lg:w-6/12">
                <h4 class="dark:text-white mx-3">Finish Appointment</h4>
            </div>
        </div>
        ...
        <div class="flex flex-wrap mt-6 -mx-3">
            <div class="w-full max-w-full px-3 mt-6 shrink-0 lg:flex-0 lg:w-8/12 lg:mt-0">
                ...
                <div class="flex-auto p-6">
                    <h5 class="font-bold dark:text-white">Prescription And notes</h5>
                  

                    <div class="flex flex-wrap mt-4 -mx-3">
                        <div class="w-full max-w-full px-3 flex-0">
                        <label class="mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80" for="description">Notes</label>
            ...
            <div class="w-full max-w-full px-3 shrink-0 lg:flex-0 lg:w-4/12">
                <div class="relative flex flex-col h-full min-w-0 break-words bg-white border-0 dark:bg-gray-950 dark:bg-opacity-20 dark:backdrop-blur-xl dark:shadow-soft-dark-xl rounded-2xl bg-clip-border">
                  <div class="flex-auto p-6">
                    <h5 class="font-bold dark:text-white">Upload Prescription</h5>
