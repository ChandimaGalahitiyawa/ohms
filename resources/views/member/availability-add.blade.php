        ...
        <div class="w-full mx-auto">
            <div accordion>
              <div accordion-section class="mb-4 rounded-t-1">
                <span class="mb-0">
                  <button section-trigger class="relative flex items-center w-full p-4 font-semibold text-left transition-all border-b border-solid cursor-pointer border-slate-100 ease-soft-in text-slate-700 rounded-t-1" aria-expanded="true">
                    Weekly Availability
              ...
              <div accordion-section class="mb-4">
                  <span class="mb-0">
                  <button section-trigger class="relative flex items-center w-full p-4 font-semibold text-left transition-all border-b border-solid cursor-pointer border-slate-100 ease-soft-in text-slate-700 rounded-t-1" aria-expanded="false">
                    Specific Availability
                    <i section-open-icon class="absolute right-0 pt-1 mr-4 leading-tight fa fa-plus text-xs"></i>
                    <i section-close-icon class="absolute right-0 hidden pt-1 mr-4 leading-tight fa fa-minus text-xs"></i>
                  </button>
                </span>
                <div section-content class="overflow-hidden transition-all ease-soft-in-out duration-350">
                    <div class="p-4 leading-normal text-sm opacity-80 ">
                    <form role="form" method="POST" action="{{ route('createSpecificAvailability') }}">
                        ...
                        <div class="mb-4">
                            <select name="centre_id" choice id="choices-centre2"  class="block w-full px-3 py-2 focus:shadow-soft-primary-outline border border-solid border-gray-300 rounded-lg">
                                <option value="">Select a Centre</option>
                                @foreach ($centres as $centre)
                                    <option value="{{ $centre->id }}">{{ $centre->centre_name }} - {{ $centre->centre_city }}</option>
                                @endforeach
