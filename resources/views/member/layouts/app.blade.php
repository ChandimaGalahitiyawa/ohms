...
<html lang="en">
  <!-- header -->
  @include('member.includes.headerlinks')
  ...
  <body class="m-0 font-sans antialiased font-normal text-left leading-default text-base dark:bg-slate-950 bg-gray-50 text-slate-500 dark:text-white/80">
    ...
    <main class="ease-soft-in-out xl:ml-68 relative h-full max-h-screen rounded-xl transition-all duration-200">
      ...
      @yield('content')
      <div fixed-plugin>
        <a fixed-plugin-button class="hidden bottom-7 right-7 text-xl z-990 shadow-soft-lg rounded-circle fixed cursor-pointer bg-white px-4 py-2 text-slate-700" aria-expanded="false">
  ...
  <!-- Footer links -->
  @include('member.includes.footerlinks')
</html>
